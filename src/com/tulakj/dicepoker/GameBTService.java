 ...
 */
public class GameBTService {
    // Debugging
    private static final String TAG = "GameActivityService";
    private static final boolean D = true;

    // Name for the SDP record when creating server socket
    private static final String NAME = "GameActivity";
    ...
    /**
     * Constructor. Prepares a new GameActivity session.
     * @param context  The UI Activity Context
     * @param handler  A Handler to send messages back to the UI Activity
     */
    public GameBTService(Context context, Handler handler) {
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(GameActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(GameActivity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (GameBTService.this) {
                        switch (mState) {
                        case STATE_LISTEN:
